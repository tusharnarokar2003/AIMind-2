...
from model_loader import smollm_model  # Changed from mistral_model
import threading
...
def load_model_background():
    try:
        smollm_model.load_model()  # Changed from mistral_model
...
def health_check():
    ...
    model_ready = smollm_model.pipe is not None  # Changed from mistral_model
    return jsonify({
        'status': 'healthy',
...
def chat():
    ...
    try:
        ...
        if not smollm_model.pipe:  # Changed from mistral_model
            return jsonify({
